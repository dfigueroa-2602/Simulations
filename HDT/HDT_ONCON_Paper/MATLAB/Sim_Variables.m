...
save('C:\Users\Dave\Documents\git\Simulations\PLECS\HDT\MAT_Variables','A', ...
    'B','C','Rfs','Rfp','Ry','Lfs','Lfp','Ly','Cfs','Cfp','Cdc','NDT', ...
    'NCT','Ts','fsw','Vg','Vs', 'Vdc','w');